    ...
    <div class="login-page">
      <div class="form">
        <form class="login-form">
          ...
          <input ref="productPrice" type="text" placeholder="Price" />
          <input ref="productUrl" type="text" placeholder="Image URL" />
          <input ref="productDesc" type="text" placeholder="Description" />
